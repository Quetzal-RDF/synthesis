...
(define (test95)
  (letrec ((p (apply make-parser '("terms" "price_per_unit" "min_units" "top99p" "monthly_overage")))
           (result (p '("if" "(" "string" "length" "of" "terms" ">" "5" ")" "then" "5" "else" "4")))
           (columnMetadata '((columnName "terms" primitiveTypes (3)) (columnName "price_per_unit" primitiveTypes (1))
                                                                     (columnName "min_units" primitiveTypes (1))(columnName "top99p" primitiveTypes (1))
                                                                     (columnName "monthly_overage" primitiveTypes (1)))))
    (println result)
...
(define (test95a)
  (letrec ((p (apply make-parser '("terms" "price_per_unit" "min_units" "top99p" "monthly_overage")))
           (result (p '("if" "(" "average" "terms" ">" "5" ")" "then" "5" "else" "4")))
           (columnMetadata '((columnName "terms" primitiveTypes (3)) (columnName "price_per_unit" primitiveTypes (1))
                                                                     (columnName "min_units" primitiveTypes (1))(columnName "top99p" primitiveTypes (1))
                                                                     (columnName "monthly_overage" primitiveTypes (1)))))
    (println result)
...
(define (test97)
  (letrec ((p (apply make-parser '("A" "B" "C")))
           (result (p '("if" "(" "if" "A" "==" "B" "then" 5 "else" 4 ")" "then" "C"))))
    (println result)))
...
(define (test101)
  (letrec ((p (apply make-parser '("A" "B" "C")))
           (result (p '("date" 20 "days" 2 "months" 1969 "years"))))
    (println result)))

(define (test102)
  (letrec ((p (apply make-parser '("A" "B" "C")))
           (result (p '("date" "(" "2" "11" "1969" ")"))))
    (println result)))
