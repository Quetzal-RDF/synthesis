...
public class SExpressionWriter extends DefaultTraversalVisitor<String, Void> {
    ...
    protected HashMap<String, Integer> colNamesToInt = new HashMap<String, Integer>();
    protected SlowSparseNumberedGraph<TypedNode> graph = new SlowSparseNumberedGraph<TypedNode>(1);
    private static Map<String, List<Integer>> functionNamesToTypes =
            new HashMap<String, List<Integer>>();
    public static Map<String, String> functionNameMap = new HashMap<String, String>();
    public static Map<String, String> functionNameNormalizedMap = new HashMap<String, String>();
    ...
    static {
        ...
        functionNameNormalizedMap.put("strcmp", NI + "_strcmp");
        ...
        functionNameNormalizedMap.put("row_number", NI + "_row_number");
        ...
        functionNameNormalizedMap.put("replace", NI + "_replace");
        ...
        functionNameNormalizedMap.put("reverse", NI + "_reverse");
        ...
        functionNameNormalizedMap.put("extractFromDate", NI + "_extractFromDate");
        ...
        functionNameNormalizedMap.put("extractDayOfMonth", NI + "_extractDayOfMonth");
        ...
        functionNameNormalizedMap.put("date_add", NI + "_date_add");
        ...
        functionNameNormalizedMap.put("date_sub_interval", NI + "_date_sub_interval");
        ...
        functionNameNormalizedMap.put("atan", NI + "_atan");
        ...
        functionNameNormalizedMap.put("sin", NI + "_sin");
        ...
        functionNameNormalizedMap.put("cos", NI + "_cos");
        ...
        functionNameNormalizedMap.put("acos", NI + "_acos");
        ...
        functionNameNormalizedMap.put("log10", NI + "_log10");
        ...
        functionNameNormalizedMap.put("log", NI + "_log");
        ...
        functionNameNormalizedMap.put("cot", NI + "_cot");
        ...
        functionNameNormalizedMap.put("tan", NI + "_tan");
        ...
        functionNameNormalizedMap.put("pow", NI + "_pow");
        ...
        functionNameNormalizedMap.put("exp", NI + "_exp");
        ...
        functionNameNormalizedMap.put("degrees", NI + "_degrees");
        ...
        functionNameNormalizedMap.put("radians", NI + "_radians");
        ...
        functionNameNormalizedMap.put("concat_ws", NI + "concat_ws");
        ...
        functionNameNormalizedMap.put("like", NI + "_like");
        ...
        functionNameNormalizedMap.put("regexp_like", NI + "_regexp_like");
    ...
    protected String visitSimpleCaseExpression(SimpleCaseExpression node, Void context) {
        ...
        for (int i = whenclauses.size() - 1; i >= 0; i--) {
            ...
            buf.append("(").append("if").append(" ")
                    ...
                    .append(process(whenclauses.get(i).getResult(), context)).append(" ").append(result)
                    .append(")");
            result = buf.toString();
        }
        return result;
    ...
    protected String visitBetweenPredicate(BetweenPredicate node, Void context) {
        ...
        Expression e1 = new ComparisonExpression(ComparisonExpression.Type.LESS_THAN, node.getValue(),
                node.getMax());
        Expression e2 = new ComparisonExpression(ComparisonExpression.Type.GREATER_THAN,
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                if (s.startsWith("Fri") || s.startsWith("Thu")
                                                                        || s.startsWith("Wed") || s.startsWith("Tue")
                                                                        || s.startsWith("Mon") || s.startsWith("Sun")
                                                                        || s.startsWith("Sat")) {
    ...
    public List<Pair<String, String>> getExpressionsAndTypes() {
        ...
        // put typed nodes into a map so we can index by colNames to int so we
        // get the exact same thing in terms of expressions and columns
        HashMap<String, String> colNamesToTypes = new HashMap<>();
        ...
        while (nodes.hasNext()) {
            ...
            if (n.name.startsWith("(in ")) {
                 colNamesToTypes.put(n.name, t.toString());
            }
        }

        // now walk through the column names to typesmap and add types if they exist in the colNamesToTypes
        for (HashMap.Entry<String, Integer> entry : colNamesToInt.entrySet()) {
            String colNum = entry.getValue().toString();
            String str = "(in " + colNum + ")";
            String typ = colNamesToTypes.get(str);
            if (typ == null) {
                typ = "( 1 )";
            }
    ...
    protected String visitComparisonExpression(ComparisonExpression node, Void context) {
        ...
        if (node.getRight() instanceof StringLiteral
                && !(processOp(node.getType().getValue()).equals("="))
                && !(processOp(node.getType().getValue()).equals("!="))) {
    ...
    protected String visitIntervalLiteral(IntervalLiteral node, Void context) {
        return "(" + "interval" + " " + node.getValue() + " " + node.getStartField() + " "
                + node.getEndField() + ")";
    }
    ...
    protected String visitIfExpression(IfExpression node, Void context) {
        ...
        putInOps("if");
        return "(" + "if" + " " + process(node.getCondition(), context) + " "
    ...
    protected String visitLogicalBinaryExpression(LogicalBinaryExpression node, Void context) {
        ...
        return "(" + op + " " + process(node.getLeft(), context) + " "
                + process(node.getRight(), context) + ")";
    }
