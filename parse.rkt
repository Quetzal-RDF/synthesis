  ...
  (let* ((column-names
         ...
         (templates (append
                     ...
                     (list
                      ...
                      (list '(add () "seconds" "to" ()) (lambda (x) (list 'add-seconds (list-ref x 4) (list-ref x 1))))
                      (list '(add () "minutes" "to" ()) (lambda (x) (list 'add-minutes (list-ref x 4)(list-ref x 1))))
                      (list '(add () "hours" "to" ()) (lambda (x) (list 'add-hours (list-ref x 4)(list-ref x 1))))
                      (list '(add () "days" "to" ()) (lambda (x) (list 'add-days (list-ref x 4)(list-ref x 1))))
                      (list '(add () "months" "to" ()) (lambda (x) (list 'add-months (list-ref x 4)(list-ref x 1))))
                      (list '(add () "years" "to" ()) (lambda (x) (list 'add-years (list-ref x 4)(list-ref x 1))))
                      
                      (list '(subtract () "seconds" "from" ()) (lambda (x) (list 'subtract-seconds (list-ref x 4)(list-ref x 1))))
                      (list '(subtract () "minutes" "from" ()) (lambda (x) (list 'subtract-minutes (list-ref x 4)(list-ref x 1))))
                      (list '(subtract () "hours" "from" ()) (lambda (x) (list 'subtract-hours (list-ref x 4)(list-ref x 1))))
                      (list '(subtract () "days" "from" ()) (lambda (x) (list 'subtract-days (list-ref x 4)(list-ref x 1))))
                      (list '(subtract () "months" "from" ()) (lambda (x) (list 'subtract-months (list-ref x 4)(list-ref x 1))))
                      (list '(subtract () "years" "from" ()) (lambda (x) (list 'subtract-years (list-ref x 4)(list-ref x 1))))
